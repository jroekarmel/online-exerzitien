...
\node[anchor=north west,inner sep=0pt]
  ...
  {\includegraphics[width=32.53pt,height=50.93pt]{poster_image_3.png}};

% _idContainer009 — embedded lower graphic
\node[anchor=north west,inner sep=0pt]
  at ([xshift=118.172pt,yshift=-698.033pt]current page.north west)
  {\includegraphics[width=467.26pt,height=98.44pt]{poster_image_4.png}};
...
\node[anchor=north west,inner sep=0pt]
  ...
  {\includegraphics[width=45.15pt,height=57.77pt]{poster_image_5.png}};
